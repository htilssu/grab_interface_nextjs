...
const Banner = ({banner, className}: { banner: StaticImageData, className?: string }) => {
    return (
        <div className="relative w-full">
            ...
            <div
                className={"absolute md:w-1/4 w-full font-bold p-5 border-[1px] border-gray-200 rounded bg-white left-0 md:left-[13%] top-2/3"}>
                ...
                <button
                    ...
                    className={"mt-5 w-full rounded-md text-white hover:bg-green-500 bg-green-600 p-2 md:p-3"}>
                    Tìm Kiếm
                </button>
            </div>
        </div>
