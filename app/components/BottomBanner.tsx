                    ...
                    <div className="">
                        <div className="flex px-20">
                            <div className="text-center p-5">
                                <div className="">
                                    <div className={"flex items-center justify-center"}>
                                        <Image alt={"food"} src={"/bottom-food-options.svg"}/>
                                    </div>
                            ...
                            <div className="text-center p-5">
                                <div>
                                    <div className={"flex items-center justify-center"}>
                                        <Image height={150} className={"max-h-[150px]"} alt={"food"} src={"/ilus-cool-features-app.svg"}/>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-center mt-10 gap-5">
                                    <a
                                        ...
                                        target="_blank" rel="noreferrer noopener" className=""><Image
