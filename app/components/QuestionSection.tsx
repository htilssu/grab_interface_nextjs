...
export default function QuestionSection() {
  ...
  return (
    <div className={"md:px-40 p-5"}>
      <div>
        <h1 className="font-bold text-4xl w-full mb-4 mt-10">
        ...
        <p className="text-sm">
          ...
          order your favorite cuisines across y your hunger with a wide
      ...
      <div className={hidden ? "hidden" : undefined}>
        ...
        <ol className="text-sm">
          ...
          <li className="p-3">
            <span className="font-bold">Checkout & Payment</span>
            <span>
              {" "}
          ...
          <li className="p-3">
            ...
            <span>
              - GrabFood has designed a seamless customer journey for you, so
              you can enjoy your food hassle-free. We will send you an instant
              email and SMS confirming your order and expected delivery time.
              Your food is then on its way.
            </span>
          </li>
        </ol>
        <hr />
        ...
        <p className="text-sm">
          Sure, we do! GrabFood accepts all forms of payments for food delivery
          services, including cash on delivery.
        </p>
      </div>
    </div>
  );
...
function Title({ content }: { content: string }) {
  return <h1 className="font-bold text-2xl w-full mb-4 mt-10">{content}</h1>;
}
