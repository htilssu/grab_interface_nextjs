                        ...
                        <div className="mt-6 text-white">
                            <div className="flex flex-col justify-center items-center md:flex-row md:justify-between font-bold">
                                <div className="ant-col-24 ant-col-lg-6">
                                    <div className="text-center md:text-left"><a href="https://www.grab.com/vn/food/"
                                                                         target="_blank" rel="noreferrer noopener">Về
                                        GrabFood</a></div>
                                    <div className="text-center md:text-left"><a href="https://www.grab.com/vn/about/"
                                                                         target="_blank" rel="noreferrer noopener">Về
                                        Grab</a></div>
                                    <div className="text-center md:text-left"><a href="https://www.grab.com/vn/food-blog/"
                                                                         target="_blank"
                                                                         rel="noreferrer noopener">Blog</a></div>
                                </div>
                                <div className="ant-col-24 ant-col-lg-6">
                                    <div className="text-center md:text-left"><a href="https://www.grab.com/vn/merchant/food/"
                                                                         target="_blank" rel="noreferrer noopener">Mở
                                        quán trên GrabFood</a></div>
                                    <div className="text-center md:text-left"><a href="https://www.grab.com/vn/driver/bike/"
                                                                         target="_blank" rel="noreferrer noopener">Trờ
                                        thành tài xế Grab</a></div>
                                </div>
                                <div className="ant-col-24 ant-col-lg-6">
                                    <div className="text-center md:text-left"><a
                            ...
                            <div className="text-white">
                                <div className="text-sm">
                                    ...
                                    <div className="flex grap-3 items-center gap-3">
                                        <a
                                            href="https://www.grab.com/vn/terms/" target="_blank"
                                            rel="noreferrer noopener">Câu
                                            hỏi thường gặp</a>
                                        <span className="dotSeperator___3KA57">•</span>
                                        <a
                                            href="https://www.grab.com/vn/privacy/" target="_blank"
                                            rel="noreferrer noopener">Chính sách bảo mật</a>
                                    </div>
                                </div>
                            </div>
                        </div>
