                        ...
                        <div className="mt-6 text-white">
                            <div className="flex justify-between font-bold">
                                <div className="ant-col-24 ant-col-lg-6">
                                    <div className=""><a href="https://www.grab.com/vn/food/"
                                                                         target="_blank" rel="noreferrer noopener">Về
                                        GrabFood</a></div>
                                    <div className=""><a href="https://www.grab.com/vn/about/"
                                                                         target="_blank" rel="noreferrer noopener">Về
                                        Grab</a></div>
                                    <div className=""><a href="https://www.grab.com/vn/food-blog/"
                                                                         target="_blank"
                                                                         rel="noreferrer noopener">Blog</a></div>
                                </div>
                                <div className="ant-col-24 ant-col-lg-6">
                                    <div className=""><a href="https://www.grab.com/vn/merchant/food/"
                                                                         target="_blank" rel="noreferrer noopener">Mở
                                        quán trên GrabFood</a></div>
                                    <div className=""><a href="https://www.grab.com/vn/driver/bike/"
